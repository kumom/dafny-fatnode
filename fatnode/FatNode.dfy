class Node {
  ...
  ghost predicate Valid() : (v : bool)
    reads this, Repr
    // COMMENT: verifying this postcondition should be the same as verifying lemma1
    // ensures v ==> forall i | 0 <= i < |valuesVersions| :: valuesVersions[i] >= ValueSetsVersions[i]
  {
